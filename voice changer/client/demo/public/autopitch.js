...
(function () {
  ...
  function build() {
    ...
    // === Row 6: Pitch quality controls (default OFF) ====================
    var hqC = cell('Pitch HQ (beta)', 'Runs pitch detection in full precision (fp32) even in fast/half mode. Steadier pitch for a negligible cost. Toggling it reloads the detector (~10s).');
    ...
    var smC = cell('Pitch smooth (beta)', 'Removes single-frame pitch spikes / octave cracks while keeping natural intonation.');
