...
Please read these Terms of Use ("Terms") before using the **feris** version of
the Voice Changer ("the software"). By downloading, installing, or using the
software, you agree to these Terms. If you do not agree, do not use the software.

> **Not legal advice.** This document is provided in good faith to set
> expectations and is not legal advice. The software is a free, open-source
> hobby project.
...
Copyright © 2022 Wataru Okada and contributors). The MIT License governs your
rights to use, copy, modify, and distribute the software. These Terms are
additional usage guidance and do not override the MIT License.

## 3. Provided "AS IS" — no warranty

THE SOFTWARE IS PROVIDED "AS IS", WITHOUT WARRANTY OF ANY KIND, EXPRESS OR
IMPLIED, INCLUDING BUT NOT LIMITED TO THE WARRANTIES OF MERCHANTABILITY, FITNESS
FOR A PARTICULAR PURPOSE, AND NONINFRINGEMENT. feris does not guarantee that the
software will be error-free, uninterrupted, secure, or fit for any particular
purpose, and provides no guarantee of support, updates, or availability.

## 4. Limitation of liability

To the maximum extent permitted by law, **feris shall not be liable** for any
direct, indirect, incidental, special, consequential, or exemplary damages
(including loss of data, hardware issues, lost profits, or reputational harm)
arising from or related to your use of (or inability to use) the software,
...
- **Consent & likeness:** You will not imitate, clone, or recreate another
  person's voice or likeness without their permission, and you will respect
  rights of publicity, personality, privacy, and biometric-data laws that apply
  to you.
- **No illegal or harmful use:** You will not use the software for fraud,
  scams, impersonation, social-engineering, deceptive "deepfakes," harassment,
  defamation, hate, or any purpose that is illegal where you live or where your
  audience is.
- **Platform & legal compliance:** You will comply with the rules of any
  platform you stream/publish to and with all applicable laws and regulations.
- **Disclosure:** Where required by law or platform policy, you will disclose
  that audio is voice-altered/synthetic.
...
models you add). Those components are governed by **their own licenses and
terms**, which you are responsible for reviewing and following. feris does not
...
arising out of or related to your use of the software, your created content, the
